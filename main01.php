...
if (isset($_POST['flag'])) {
  ...
  if ($result) {
    echo "<script>alert('謝謝您!送出資料已經收到，我們會盡速與您連絡');</script>";
  } else {
    echo "<script>alert('資料無法寫入，請與管理員連絡');</script>";
  }
}
?>
<!DOCTYPE html>
...
<body>
    <nav class="navbar fixed-top mx-auto  navbar-expand-lg  bg-indigo navbar-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0 ">
                        <li class="nav-item">
                            <a class="navbar-brand mx-auto mb-2 mb-lg-0" href="index.php"><i class="fa-regular fa-house-user fa-flip fa-2xl" style="color: #B197FC; margin-top:5px;margin-left:5px;"></i></a>
                        </li>
                        <!-- <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="index.php"><img src="./images/lincanLogo.png" alt="LOGO" class="img-fluid"></a>
                        </li> -->
                        <!-- <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item dropend">
                                    <a href="#" class="dropdown-item dropdown-toggle">Submenu-1</a>
                                    <ul class="dropdown-menu">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">測試中心</a>
                            <ul class="dropdown-menu">
                                <li class="nav-item dropend">
        ...
        <div class="container text-center">
            ...
            <div class="row">
                <div class="card col-md-4">
                    <img src="images/pic61.jpg" class="card-img-top" alt="adidas 休閒慢跑鞋">
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-before-after">更多資訊</a>
                        <a href="#" class="btn btn-before-after">放購物車</a>
                    </div>
                </div>
                <div class="card col-md-4">
                    <img src="images/pic62.jpg" class="card-img-top" alt="Reebok 休閒慢跑鞋">
                    <div class="card-body">
                ...
                <div class="card col-md-4">
                    <img src="images/pic63.jpg" class="card-img-top" alt="Nike 阿甘鞋">
                    <div class="card-body">
            ...
            <div class="row">
                <div class="card col-md-4">
                    <img src="images/pic64.jpg" class="card-img-top" alt="Puma 慢跑鞋">
                    <div class="card-body">
                ...
                <div class="card col-md-4">
                    <img src="images/pic65.jpg" class="card-img-top" alt="Asics 慢跑鞋">
                    <div class="card-body">
                ...
                <div class="card col-md-4">
                    <img src="images/pic66.jpg" class="card-img-top" alt="美津濃 Mizuno Prophecy 5">
                    <div class="card-body">
    ...
    <sectiom id="sportlogo">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-3"><img src="./images/pic71.jpg" class="img-fluid" alt="adidas" title="adidas"></div>
                <div class="col-sm-3"><img src="./images/pic72.jpg" class="img-fluid" alt="Reebok" title="Reebok"></div>
                <div class="col-sm-3"><img src="./images/pic73.jpg" class="img-fluid" alt="Mizuno" title="Mizuno"></div>
                <div class="col-sm-3"><img src="./images/pic74.jpg" class="img-fluid" alt="Nike" title="Nike"></div>
            </div>
            <div class="row">
                <div class="col-sm-3"><img src="./images/pic75.jpg" class="img-fluid" alt="Kappa" title="Kappa"></div>
                <div class="col-sm-3"><img src="./images/pic76.jpg" class="img-fluid" alt="PUMA" title="PUMA"></div>
                <div class="col-sm-3"><img src="./images/pic77.jpg" class="img-fluid" alt="CONVERSE" title="CONVERSE"></div>
                <div class="col-sm-3"><img src="./images/pic78.jpg" class="img-fluid" alt="SPRIT" title="SPRIT"></div>
            </div>
        </div>
    </sectiom>
    <hr>
        ...
        <div class="container text-center">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    ...
                    <button class="btn btn-sm btn-danger"><i class="fas fa-balance-scale fa-lg pe-2" aria-hidden="true"></i>
                        Show More</button>
                </div>
                <div class="col-sm-2">
            ...
            <div class="row">
                <div class="col-sm-8 offset-2">
                    <form action="main.php" method="POST" id="form1">
                        ...
                        <br>
                        <div class="row"><textarea rows="6" class="form-control" name="message" id="message" placeholder="Message" require></textarea><input type="hidden" name="flag" id="flag" value="form1"></div>
                        <br>
    ...
    <section id="footer">
        <div class="container text-center">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-x1-12">COPYRIGHT &copy; LINCAN SPORT SERVICE CO, ALL RIGHT RESERED.
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(function(){ //當網頁載入時即執行下方程式
            $(window).scroll(function(){//監聽瀏覽器的捲軸，當滑鼠的滾輪動作時，即執行下列程式。
                var  scroll_position = $(window).scrollTop();
                //讀取瀏覽器離TOP的距離/2，得出來的數值
                $('#mainmenu').css({
                    'background-position-x': -scroll_position + 'px',
                    //設定ID,mainmume的CSS背景X軸，使用負數的方式，進行背景的移動。
                });
            });
        });
    </script>
